...
function addTopLine(isMobile) {
    ...
    var html = '<style>.top-line span.mobile{height: 35px;padding-top: 10px;font-size: 12px !important;box-sizing: border-box;}' +
        ...
        '<span class="all-today '+(isMobile ? 'mobile' : '')+'">����������� �������: <strong>' + allToday + '</strong></span>' +
        '<span class="now '+(isMobile ? 'mobile' : '')+'">������ �� �����: <strong>' + now + '</strong></span>' +
        '<span class="today-buy '+(isMobile ? 'mobile' : '')+'">������� �������: <strong>' + todayBuy + '</strong></span>' +
        '</div></div>';
...
function freezeMoney(balance, dollar) {
    var html = '<style>' +
        ...
        '<div class="freezing-info-packages">�������� <span class="packages-count">' + balance + '</span> ���� <br>�� ������� �����' +
        '</div>' +
