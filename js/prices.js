var mleadsnew = '9ceOZn8iF4HEOYyawfv3hVv4Jqa3pU33';var cartinfo = {"country":"UA","prices":{"6880":{"AE":{"price":"149.00","percent":"0","dostavka":"20","old_price":"100","geo_code":"AE","geo_name":"\u0410\u0440\u0430\u0431\u0441\u043a\u0438\u0435 \u042d\u043c\u0438\u0440\u0430\u0442\u044b","currency":"AED","currency_code":"AED","description":"","name":"The Cooler Bag SANNE - 8L"}}},"tel":[]};var footertext = 'ООО «МОНСТР-МЕДИА» ИНН 7701071884<br>ОГРН 1157746018870<br/><a onclick="javascript: cartPolitika();" style="cursor: pointer;">\u041F\u043E\u043B\u0438\u0442\u0438\u043A\u0430 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438 </a><br/><a href="http://monsterleads.pro/?utm_source=from_land" target="_blank">MonsterLeads.Pro</a>';function cartFrameInit(params) {
    console.log("init");
    ...
    ;
    iframe.src = 'http://c.cpam.pro/' + landing_id + '/frame?mleads=9ceOZn8iF4HEOYyawfv3hVv4Jqa3pU33&t=' + parseInt(cartStartTime || 0) + '&product_id=' + product_id + (type !== '' ? '&type=' + type : '') + (params.subtype === 'fast_call' ? '&subtype=fast_call' : '') + (params.tel ? '&tel=' + encodeURIComponent(params.tel) : '');
...
function sendBaseEvent(event) {var http = new XMLHttpRequest();var url = "https://c.cpam.pro/30121/cross_query?&code=&geo_id=2&subid_id=&subid2_id=&subid3_id=&subid4_id=&subid5_id=&event_trigger=true&unique=1&event=" + event;var params = "";http.open("POST", url, true);http.onreadystatechange = function(){if (http.readyState == 4) {}};http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");http.send(params);};